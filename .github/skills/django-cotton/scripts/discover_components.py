...
def print_components(components, output="list"):
    """
    Print components in various outputs.

    Args:
        components (list): List of component names
        output (str): Output format - 'list', 'usage', or 'grouped'
    """
    if not components:
...
if __name__ == "__main__" or "__file__" not in locals():
    ...
    # You can change the output here: 'list', 'usage', or 'grouped'
    print_components(components, output="grouped")
